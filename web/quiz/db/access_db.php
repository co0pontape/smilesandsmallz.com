...
class xyz1zyx {
    ...
    {
        $y1= "select m.*, u.UserID as user_id, u.user_type,u.password, 0 as imported from users u " .
        ...
        $y1.=" union ";
        $y1.="select m.*, u.UserID as user_id, 2 as user_type,u.password, 1 as imported from v_imported_users u ".
