...
<table class="desc_text" style="width:850px">
    ...
    <tr>
        ...
        <td>
            <input style="width:100px" type="text" id="txtPoint" value="<?php echo xyz96zyx::xyz100zyx("txtPoint") ?>" name="txtPoint">
        </td>
    </tr>
    <tr>
        <td valign="top">
        ...
        <td>
            <textarea style="width:100%;height:70px" id="txtHeader" name="txtHeader"><?php echo xyz96zyx::xyz100zyx("txtHeader") ?></textarea>
        </td>
    </tr>
    <tr>
        <td valign="top">
        ...
        <td>
            <textarea style="width:100%;height:70px" id="txtFooter" name="txtFooter"><?php echo xyz96zyx::xyz100zyx("txtFooter") ?></textarea>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td align="center">
            <table class="desc_text" id="tblMulti" >
                <tr>
                    ...
                    <td><input type="text" value="<?php echo xyz96zyx::xyz100zyx("txtGroupName") ?>"  name="txtMultiGroupName" id="txtMultiGrpName"></td>
                </tr>
                <tr>
                    <td colspan="2"><hr></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="txtChoise1" value="<?php echo xyz96zyx::xyz100zyx("txtChoise$i") ?>" name="txtMulti<?php echo $i ?>"></td>
                    <td><input <?php echo xyz96zyx::xyz100zyx("ans_selected$i") ?> type="checkbox" id="chkMulti<?php echo $i ?>" name="chkMulti<?php echo $i ?>" ></td>
                </tr>
                <?php } ?>
            </table>
            <table width="170px">
    ...
    <tr style="display:none" id="trOne" >
        <td align="center">
            <table id="tblOne" class="desc_text" >
                <tr>
                    <td>Header text (can be empty):</td>
                    <td><input type="text" value="<?php echo xyz96zyx::xyz100zyx("txtGroupName") ?>" name="txtOneGroupName"></td>
                </tr>
                 <tr>
                    <td colspan="2"><hr></td>
                </tr>
                ...
                <tr>
                    <td>
                        <input type="text" id="txtChoise<?php echo $i ?>" name="txtOne<?php echo $i ?>" value="<?php echo xyz96zyx::xyz100zyx("txtChoise$i") ?>"></td>
                    <td><input <?php echo xyz96zyx::xyz100zyx("ans_selected$i") ?> type="radio" name="rdOne" value="<?php echo $i ?>"></td>
                </tr>
                <?php } ?>
            </table>
            <table width="170px">
    ...
    <tr style="display:none" id="trArea">
        <td align="center">
            <table id="tblArea" class="desc_text">
                 <tr>
                    ...
                    <td>
                        <input style="width:300px" type="text" value="<?php echo xyz96zyx::xyz100zyx("txtGroupName") ?>" name="txtAreaGroupName"></td>
                ...
                <tr>
                    ...
                    <td>
                        <textarea style="width:300px;height:100px" name="txtArea1"><?php echo xyz96zyx::xyz100zyx("txtCrctAnswer1") ?></textarea>
                    <td>
                </tr>
            </table>
        </td>
        ...
        <td align="center">
            <table id="tblMultiText" class="desc_text">
                <tr>
                    <td>Header text (can be empty):</td>
                    <td><input type="text" value="<?php echo xyz96zyx::xyz100zyx("txtGroupName") ?>" name="txtMultiTextGroupName"></td>
                </tr>
               <tr>
                    <td colspan="2"><hr></td>
                </tr>
               <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="txtChoise<?php echo $i ?>" name="txtMultiText<?php echo $i ?>" value="<?php echo xyz96zyx::xyz100zyx("txtChoise$i") ?>"></td>
                    <td><input type="text" id="txtText<?php echo $i ?>" name="txtMultiCrctAnswer<?php echo $i ?>" value="<?php echo xyz96zyx::xyz100zyx("txtCrctAnswer$i") ?>"></td>
                </tr>
                <?php } ?>
            </table>          
             <table width="320px">
