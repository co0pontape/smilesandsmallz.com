...
<table class="desc_text" border="0" width="100%">
    ...
    <tr>
        <td>Name :</td>
        <td><input class="st_txtbox" type="text" id="txtName" name="txtName" value="<?php echo xyz96zyx::xyz100zyx("txtName") ?>" /></td>
    </tr>
    <tr>
        <td>Description :</td>
        <td><input class="st_txtbox" type="text" id="txtDesc" name="txtDesc" value="<?php echo xyz96zyx::xyz100zyx("txtDesc") ?>" /></td>
    </tr>
     <tr>
        <td>Show intro :</td>
        <td ><input  type="CHECKBOX" id="chkShowIntro" name="chkShowIntro" <?php echo xyz96zyx::xyz100zyx("chkShowIntro") ?>  /></td>
    </tr>
    <tr>
        <td>Intro text :</td>
        <td >
