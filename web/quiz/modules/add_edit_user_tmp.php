...
<table class="desc_text">
    <tr>
        ...
        <td><input type="textbox" id="txtName" name="txtName" value="<?php echo xyz96zyx::xyz100zyx("txtName") ?>" /></td>
    </tr>
    <tr>
        <td>Surname : </td>
        <td><input type="textbox" id="txtSurname" name="txtSurname" value="<?php echo xyz96zyx::xyz100zyx("txtSurname") ?>" /></td>
    </tr>
    <tr>
        <td>Email : </td>
        <td><input type="textbox" id="txtEmail" name="txtEmail" value="<?php echo xyz96zyx::xyz100zyx("txtEmail") ?>"  /></td>
    </tr>
    <tr>
        <td>User type : </td>
        <td>
    ...
    <tr>
        <td>Login : </td>
        <td><input <?php echo $login_disabled ?> type="textbox" id="txtLogin" name="txtLogin" value="<?php echo xyz96zyx::xyz100zyx("txtLogin") ?>" /></td>
    </tr>
     <tr>
        <td>Password : </td>
        <td>
            
            <input style="display:<?php echo $psw_display ?>" type="textbox" id="txtPassword" name="txtPassword" value="<?php echo xyz96zyx::xyz100zyx("txtPasswordValue") ?>" />
