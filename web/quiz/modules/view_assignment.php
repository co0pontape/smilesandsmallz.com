...
xyz94zyx::xyz95zyx("1");
 ...
 $b2 = array("User ID", "Name", "Surname","User name","Status","Success","Total point","&nbsp;");
 $b3 = array("user_id"=>"text", "Name"=>"text","Surname"=>"text","UserName"=>"text","status_name"=>"text","is_success"=>"text","total_point"=>"text");
